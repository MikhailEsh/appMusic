 ...
 */
public class ItemMusicGroupImpl implements ItemMusicGroup {
    ...
    public ItemMusicGroupImpl(String name, String description, String link, String linkSmallImage, String linkBigImage, Integer albums, Integer tracks, Integer id, String[] genres, Context context) {
        this.name = name;
